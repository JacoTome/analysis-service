...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, AnalysisMessage> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String,AnalysisMessage> kafkaListenerContainerFactory() {
